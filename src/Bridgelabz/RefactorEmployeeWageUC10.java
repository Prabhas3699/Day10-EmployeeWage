...
public class RefactorEmployeeWageUC10 {
	/*
	...
	int totalCompanies;
	//Array of companies
	RefactorEmployeeWageUC10[] companies;
	int i;
	/*
	 * @param wage_Per_Hour
	 * @param totalHours
	 ...
	 * @param companyName
	 */
	public RefactorEmployeeWageUC10(String companyName, int wage_Per_Hour, int totalHours, int totalDays) {
		super();
	...
	public void addCompany(String companyName, int wage_Per_Hour, int totalHours, int totalDays) {
		 ...
		 * method for array
		 */
		companies[i++]=new RefactorEmployeeWageUC10(companyName, wage_Per_Hour, totalHours, totalDays);
	}
	
	/*
	 * @param totalCompanies
	 */
	public RefactorEmployeeWageUC10(int totalCompanies) {
		super();
		this.totalCompanies = totalCompanies;
		companies=new RefactorEmployeeWageUC10[totalCompanies];
		i=0;
	}
	...
	public  void  calculateTotalWage(){
		for(RefactorEmployeeWageUC10 company:companies) {
	...
	public  int  calculateTotalWage(RefactorEmployeeWageUC10 empCompany) {
		System.out.println("-----------------------------------------------------");
