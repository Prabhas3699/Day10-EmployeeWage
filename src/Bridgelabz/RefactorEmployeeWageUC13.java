...
public class RefactorEmployeeWageUC13 {
	/*
	 ...
	 * @param companyName
	 */
	public RefactorEmployeeWageUC13(String companyName, int wage_Per_Hour, int totalHours, int totalDays) {
		super();
	...
	public void addCompany(String companyName, int wage_Per_Hour, int totalHours, int totalDays) {
		RefactorEmployeeWageUC13 company=new RefactorEmployeeWageUC13(companyName, wage_Per_Hour, totalHours, totalDays);
		/*
	...
	public  void  calculateTotalWage(){
		for(RefactorEmployeeWageUC13 company:companies) {
	...
	public  int  calculateTotalWage(RefactorEmployeeWageUC13 empCompany) {
		System.out.println("-----------------------------------------------------");
